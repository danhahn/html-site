...
const Html5 = ({ size = 20, color = "light" }) => {
  const isDark = color === "dark" ? true : false;
  const colors = {
    primary: isDark ? "#E34F26" : "#fff",
    primaryAlt: isDark ? "#EF652A" : "#f0f0f0",
    light: isDark ? "#FFF" : "#e44d26",
    lightAlt: isDark ? "#EBEBEB" : "#e44d26"
  };
  return (
    <svg
    ...
    >
      ...
      <path fill={colors.primary} d="M71,460 L30,0 481,0 440,460 255,512" />
      <path fill={colors.primaryAlt} d="M256,472 L405,431 440,37 256,37" />
      <path
